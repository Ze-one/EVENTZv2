...
import { ScanLog, Participant, ScanResult } from '../types.js';
import { BarChart2, ShieldAlert, CheckCircle2, Download, Trash2, Calendar, Search, ShieldCheck } from 'lucide-react';
...
export default function ReportsView({ scanLogs, participants, onClearLogs, onRefresh }: ReportsViewProps) {
