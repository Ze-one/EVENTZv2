...
export default function EventSettingsView({ event, onSave }: EventSettingsViewProps) {
  ...
  const [design, setDesign] = useState<PassDesign>(getPassDesign(event));
